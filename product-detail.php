...
<?php 
    ...
    if (!isset($_GET['productid']) || $_GET['productid'] == NULL ) {
        ...
        $id = $_GET['productid'];
        // $id = preg_replace('/(?<!^)([A-Z][a-z]|(?<=[a-z])[^a-z]|(?<=[A-Z])[0-9_])/', '', $_GET['productid']);
    }
                            ...
                            <div class="pd u-s-m-b-30">
                                <div class="slider-fouc pd-wrap">
                                    <div id="pd-o-initiate">
                                        <div class="pd-o-img-wrap" data-src="admin/<?php echo $result ['image']; ?>">

                                            <img class="u-img-fluid" src="admin/<?php echo $result ['image'];?>" data-zoom-image="admin/<?php echo $result ['image']; ?>" alt="">
                                        </div>
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="pd-detail">
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <span class="pd-detail__preview-desc"><?php echo $fm->textShorten($result['body'], 240);  ?></span></div>
                                <div class="u-s-m-b-15">
                                    <div class="pd-detail__inline">
                                ...
                                <div class="u-s-m-b-15">
                                    <form class="pd-detail__form" action="" method="post">
                                        <div class="pd-detail-inline-2">
                                            ...
                                            <div class="u-s-m-b-15">
                                                <button class="btn btn--e-brand-b-2" type="submit" name="submit">Add to Cart</button>
                                            </div>
                                        </div>
                                    </form>
