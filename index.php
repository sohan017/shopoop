                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5 col-md-5 u-s-m-b-30">
                                ...
                                <a class="collection" href="products.php">
                ...
                <div class="section__intro u-s-m-b-16">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section__text-wrap">
                                    <h1 class="section__heading u-c-secondary u-s-m-b-12">TOP BRAND</h1>

                                    <span class="section__span u-c-silver">CHOOSE TOP BRAND PRODUCT</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <li class="column-product__item">
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.php">
                            ...
                            <div class="col-lg-6 col-md-6 u-s-m-b-30">
                                <div class="product-o product-o--radius product-o--hover-off u-h-100">
                                    ...
                                    <span class="product-o__name">
                                        ...
                                        <a href="product-detail.php">DJI Phantom Drone 4k</a></span>
                            ...
                            <div class="col-lg-6 col-md-6 u-s-m-b-30">
                                <div class="product-o product-o--radius product-o--hover-off u-h-100">
                                    ...
                                    <span class="product-o__name">
                                        ...
                                        <a href="product-detail.php">DJI Phantom Drone 2k</a></span>
                                    <div class="product-o__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                ...
                                <div class="u-s-m-b-30">
                                    <div class="product-o product-o--hover-on">
                                        <div class="product-o__wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.php?productid=<?php echo $result ['productId']; ?>">

                                                <img class="aspect__img" src="admin/<?php echo $result ['image']; ?>" alt=""></a>
                                            <div class="product-o__action-wrap">
                                                <ul class="product-o__action-list">
                                                    <li>
                                        ...
                                        <span class="product-o__category">
                                            ...
                                            <a href="products.php"><?php echo $result ['catName']; ?></a></span>

                                        <span class="product-o__name">

                                            <a href="product-detail.php?productid=<?php echo $result ['productId']; ?>"><?php echo $result ['productName']; ?></a></span>
                                        ...
                                        <span class="product-o__price">$<?php echo $result ['price'] ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="banner-bg__wrap">
                                    ...
                                    <a class="banner-bg__shop-now btn--e-secondary" href="products.php">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
                                <div class="product-o product-o--hover-on u-h-100">
                                    ...
                                    <span class="product-o__category">
                                        ...
                                        <a href="product-detail.php?productid=<?php echo $result ['productId']; ?>"><?php echo $result['catName']; ?></a>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                                ...
                                <a class="promotion" href="products.php">
                                    <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <div class="pd-breadcrumb u-s-m-b-30">
                                    <ul class="pd-breadcrumb__list">
                                        ...
                                        <li class="has-separator">
                                            ...
                                            <a href="products.php">Electronics</a></li>
                                        <li class="has-separator">

                                            <a href="products.php">DSLR Cameras</a></li>
                                        <li class="is-marked">
                    ...
                    <div class="modal-body">
                        <div class="row u-s-m-x-0">
                            <div class="col-lg-6 new-l__col-1 u-s-p-x-0">
                                ...
                                <a class="new-l__img-wrap u-d-block" href="products.php">
